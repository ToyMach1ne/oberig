...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<p><a href="#" class="shipping-calculator-button"><?php _e( 'Посчитать доставку', 'woocommerce' ); ?></a></p>
	...
	<section class="shipping-calculator-form" style="display:none;">
		...
		<p><button type="submit" name="calc_shipping" value="1" class="button"><?php _e( 'Обновить суму', 'woocommerce' ); ?></button></p>
