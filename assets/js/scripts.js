...
$(".tabs li").click(function(e) {
    ...
    var activetId = $('.product-tabs-wrapp .intro').attr('id');
    activetId = '#' + activetId;
    ...
    if ($(this).hasClass('description_tab')) {
        $("#tab-description").addClass("intro");
    } else if ($(this).hasClass('additional_information_tab')) {
        $("#tab-additional_information").addClass("intro");
    } else if ($(this).hasClass('delivery_tab')) {

        $("#delivery").addClass("intro");
    } else {
